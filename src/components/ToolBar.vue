<template>
  <Transition name="popup-r-lg">
    <div class="fixed bottom-6 right-4 flex flex-col space-y-1" v-show="!showSettingPanel">
      ...
      <button v-show="showToolBarBtn.top"
        class="rounded-md bg-gray-300/80 hover:bg-blue-500 hover:text-white p-2 transition-colors"
      ...
      <button v-show="showToolBarBtn.bottom"
        class="rounded-md bg-gray-300/80 hover:bg-blue-500 hover:text-white p-2 transition-colors"
...
const { showSettingPanel, showToolBarBtn } = toRefs(store)
